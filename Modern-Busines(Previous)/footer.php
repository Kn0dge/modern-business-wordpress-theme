...
$footer_link_hover_color = get_theme_mod('footer_link_hover_color', '#ff6600');
$footer_text_align = get_theme_mod('footer_text_align', 'center');
$footer_padding_top = get_theme_mod('footer_padding_top', 20);
$footer_padding_bottom = get_theme_mod('footer_padding_bottom', 20);
$footer_margin_top = get_theme_mod('footer_margin_top', 0);
$footer_margin_bottom = get_theme_mod('footer_margin_bottom', 0);
...
$footer_style = sprintf(
    ...
    esc_attr($footer_text_align),
    intval($footer_padding_top),
    intval($footer_padding_bottom),
    intval($footer_margin_top),
    intval($footer_margin_bottom),
    intval($footer_font_size)
);
?>
    <style>
        #colophon a {
...
<?php
$footer_layout = get_theme_mod('footer_layout', 'standard');
$footer_classes = 'site-footer footer-layout-' . esc_attr($footer_layout);
?>
<footer id="colophon" class="<?php echo $footer_classes; ?>" style="<?php echo $footer_style; ?>">
        <div class="container">
