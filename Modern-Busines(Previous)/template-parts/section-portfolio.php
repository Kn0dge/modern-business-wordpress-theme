...
<section id="portfolio" class="section portfolio-section" style="
    background-color: <?php echo esc_attr(get_theme_mod('portfolio_bg_color', '#ffffff')); ?>; 
    color: <?php echo esc_attr(get_theme_mod('portfolio_text_color', '#000000')); ?>;
    text-align: <?php echo esc_attr(get_theme_mod('portfolio_text_align', 'center')); ?>;
    padding-top: <?php echo esc_attr(get_theme_mod('portfolio_padding_top', 50)); ?>px;
    padding-bottom: <?php echo esc_attr(get_theme_mod('portfolio_padding_bottom', 50)); ?>px;
    margin-top: <?php echo esc_attr(get_theme_mod('portfolio_margin_top', 0)); ?>px;
    margin-bottom: <?php echo esc_attr(get_theme_mod('portfolio_margin_bottom', 0)); ?>px;
    font-size: <?php echo esc_attr(get_theme_mod('portfolio_font_size', 18)); ?>px;
">
    <div class="container">
